...
class Normalizer
{
    ...
    public static function normalize(string $s, int $form = self::FORM_C)
    {
        ...
        if (null !== $mbEncoding = ((2 /* MB_OVERLOAD_STRING */ & (int) \ini_get('mbstring.func_overload')) !== 0) ? mb_internal_encoding() : null) {
    ...
    private static function recompose($s)
    {
        ...
        while ($i < $len) {
            if ($s[$i] < "\x80") {
                ...
                if (($j = strspn((string) $s, (string) $ASCII, $i + 1)) !== 0) {
