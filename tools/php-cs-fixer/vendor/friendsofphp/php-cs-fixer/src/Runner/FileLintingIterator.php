...
{
    private ?\PhpCsFixer\Linter\LintingResultInterface $currentResult = null;

    /**
     * @param \Iterator<mixed, \SplFileInfo> $iterator
     */
    public function __construct(\Iterator $iterator, private readonly LinterInterface $linter)
    {
