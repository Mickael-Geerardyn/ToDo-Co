...
class ClassLoader
{
    ...
    public function add($prefix, $paths, $prepend = false)
    {
        $paths = (array) $paths;
        if ($prefix === '' || $prefix === '0') {
            $this->fallbackDirsPsr0 = $prepend ? [...$paths, ...$this->fallbackDirsPsr0] : [...$this->fallbackDirsPsr0, ...$paths];
        ...
        if ($prepend) {
            $this->prefixesPsr0[$first][$prefix] = [...$paths, ...$this->prefixesPsr0[$first][$prefix]];
        } else {
            $this->prefixesPsr0[$first][$prefix] = [...$this->prefixesPsr0[$first][$prefix], ...$paths];
        }
    }
    ...
    public function addPsr4($prefix, $paths, $prepend = false)
    {
        ...
        if ($prefix === '' || $prefix === '0') {
            ...
            $this->fallbackDirsPsr4 = $prepend ? [...$paths, ...$this->fallbackDirsPsr4] : [...$this->fallbackDirsPsr4, ...$paths];
            ...
            $this->prefixDirsPsr4[$prefix] = [...$paths, ...$this->prefixDirsPsr4[$prefix]];
        } else {
            // Append directories for an already registered namespace.
            $this->prefixDirsPsr4[$prefix] = [...$this->prefixDirsPsr4[$prefix], ...$paths];
        }
    }
     ...
     * @return void
     */
    private function initializeIncludeClosure()
    {
